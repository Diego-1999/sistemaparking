...
namespace SistemaParking
{
    public partial class EstablecerTarifa : Form
    {
        ...
        private void txtFranccionMinuto_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtMontoHora_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && (e.KeyChar != '.'))
            {
                e.Handled = true;
        ...
        private void txtMontoFranccionMinuto_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && (e.KeyChar != '.'))
            {
                e.Handled = true;
